public class Produto3 {
    ...
    public Produto3(String descricao, int quant, double precoUnit) {
    ...
    public String exibe() {
        return "\n" +
                "Descricao: " + descricao + '\'' +
                "\nQuantidade em Estoque: " + quant +" Preço unitário: R$ "+ precoUnit +
                "\nValor do estoque: R$ " + obtemValorEstoque();
    }
    public String exibeEmLinha() {
        return "\n" +
                "   " + descricao + '\'' +
                ", Quantidade em Estoque: " + quant +
                ", Valor: " + precoUnit +
